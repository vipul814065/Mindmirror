  ...
  test: {
    ...
    coverage: {
      ...
      include: [
        ...
        "src/components/ui/CompetitionPitchPanel.tsx",
        "src/components/ui/ChallengeRequirementsCoverage.tsx",
        "src/components/journal/JournalAnalysisPanel.tsx",
        "src/lib/ai/mindfulness-exercises.ts",
      ],
      exclude: [
        "src/lib/demo/**",
